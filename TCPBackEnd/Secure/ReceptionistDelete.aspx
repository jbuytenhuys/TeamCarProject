...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblDeleteAuth" runat="server" style="z-index: 1; left: 266px; top: 204px; position: absolute; width: 362px; height: 29px" Text="Are you sure you want to delete this car from the database?"></asp:Label>
        <p>
