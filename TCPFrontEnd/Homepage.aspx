...
<body style="height: 611px">
    ...
    <div style="height: 606px">
        ...
        <asp:ImageButton ID="btnHatchbacks" runat="server" ImageUrl="~/Images/A-160-Sport_jpg_asset_UPqedCzsqR5sG6aEseWjUtmCFNJLMDuH7RjAVKZGABo.jpg" style="z-index: 1; left: 212px; top: 322px; position: absolute; height: 166px; width: 232px" OnClick="ImageButton1_Click" />
        ...
        <asp:Button ID="btnAboutUs" runat="server" style="z-index: 1; left: 201px; top: 559px; position: absolute; right: 1227px" Text="About Us" />
