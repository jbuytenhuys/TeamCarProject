...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnSalesmanHomepage" runat="server" OnClick="Button3_Click" style="z-index: 1; left: 508px; top: 267px; position: absolute; height: 58px; width: 119px; margin-bottom: 0px" Text="Salesman" />
